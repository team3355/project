...
export declare class AWSS3Provider implements StorageProvider {
     ...
     */
    copy(src: S3CopySource, dest: S3CopyDestination, config?: S3ProviderCopyConfig, userAgentValue?: string): Promise<S3ProviderCopyOutput>;
    /**
     ...
     */
    get<T extends S3ProviderGetConfig & StorageOptions>(key: string, config?: T, userAgentValue?: string): Promise<S3ProviderGetOuput<T>>;
    /**
     ...
     */
    getProperties(key: string, config?: S3ProviderGetPropertiesConfig, userAgentValue?: string): Promise<S3ProviderGetPropertiesOutput>;
    /**
     ...
     * success.
     */
    put<T extends S3ProviderPutConfig>(key: string, object: PutObjectInput['Body'], config?: T, userAgentValue?: string): S3ProviderPutOutput<T>;
    /**
     ...
     */
    remove(key: string, config?: S3ProviderRemoveConfig, userAgentValue?: string): Promise<S3ProviderRemoveOutput>;
    private _list;
    /**
     ...
     */
    list(path: string, config?: S3ProviderListConfig, userAgentValue?: string): Promise<S3ProviderListOutput>;
