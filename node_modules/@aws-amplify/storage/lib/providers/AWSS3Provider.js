...
var AWSS3Provider = exports.AWSS3Provider = /** @class */ (function () {
     ...
     */
    AWSS3Provider.prototype.copy = function (src, dest, config, userAgentValue) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _c.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, (0, S3_1.copyObject)((0, S3ClientUtils_1.loadS3Config)(__assign(__assign({}, opt), { userAgentValue: userAgentValue })), params)];
                    case 3:
                        _c.sent();
    ...
    AWSS3Provider.prototype.get = function (key, config, userAgentValue) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        s3Config = (0, S3ClientUtils_1.loadS3Config)(__assign(__assign({}, opt), { emitter: emitter, userAgentValue: userAgentValue }));
     ...
     */
    AWSS3Provider.prototype.getProperties = function (key, config, userAgentValue) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        s3Config = (0, S3ClientUtils_1.loadS3Config)(__assign(__assign({}, opt), { userAgentValue: userAgentValue }));
                        params = {
                            Bucket: bucket,
                            Key: final_key,
                        };
     ...
     * success.
     */
    AWSS3Provider.prototype.put = function (key, object, config, userAgentValue) {
        ...
        var uploader = new AWSS3ProviderManagedUpload_1.AWSS3ProviderManagedUpload(params, __assign(__assign({}, opt), { userAgentValue: userAgentValue }), emitter);
        if (acl) {
            params.ACL = acl;
        }
        if (resumable === true) {
            var s3Config = (0, S3ClientUtils_1.loadS3Config)(__assign(__assign({}, opt), { userAgentValue: userAgentValue }));
            var addTaskInput = {
                bucket: bucket,
                key: key,
                s3Config: s3Config,
     ...
     */
    AWSS3Provider.prototype.remove = function (key, config, userAgentValue) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AWSS3Provider.prototype._list = function (params, opt, prefix, userAgentValue) {
        return __awaiter(this, void 0, void 0, function () {
            var list, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, S3_1.listObjectsV2)((0, S3ClientUtils_1.loadS3Config)(__assign(__assign({}, opt), { userAgentValue: userAgentValue })), __assign({}, params))];
                    case 1:
                        response = _a.sent();
     ...
     */
    AWSS3Provider.prototype.list = function (path, config, userAgentValue) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        _c.label = 3;
                    case 3: return [4 /*yield*/, this._list(params, opt, prefix, userAgentValue)];
                    case 4:
                        listResult = _c.sent();
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, this._list(params, opt, prefix, userAgentValue)];
                    case 8:
                        listResult = _c.sent();
