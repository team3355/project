...
var InternalInAppMessagingClass = /** @class */ (function () {
    ...
    InternalInAppMessagingClass.prototype.configure = function (_a) {
        ...
        var _b = (notificationsConfig === null || notificationsConfig === void 0 ? void 0 : notificationsConfig.InAppMessaging) || {}, _c = _b.listenForAnalyticsEvents, listenForAnalyticsEvents = _c === void 0 ? true : _c, config = __rest(_b, ["listenForAnalyticsEvents"]);
    ...
    InternalInAppMessagingClass.prototype.syncMessages = function (customUserAgentDetails) {
        var _this = this;
        return Promise.all(this.pluggables.map(function (pluggable) { return __awaiter(_this, void 0, void 0, function () {
