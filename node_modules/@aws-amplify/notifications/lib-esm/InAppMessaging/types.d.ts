...
import { NotificationsConfig, NotificationsProvider, NotificationsSubCategory as NotificationsSubCategories, UserInfo } from '../types';
export declare type NotificationsSubCategory = Extract<NotificationsSubCategories, 'InAppMessaging'>;
export declare type InternalNotificationsSubCategory = 'InternalInAppMessaging';
