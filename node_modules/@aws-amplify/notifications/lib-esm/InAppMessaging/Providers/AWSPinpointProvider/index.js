...
var AWSPinpointProvider = /** @class */ (function (_super) {
    ...
    function AWSPinpointProvider() {
        ...
        _this.getInAppMessages = function (userAgentValue) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, getInAppMessages({ credentials: credentials, region: region, userAgentValue: userAgentValue }, input)];
                    case 5:
                        response = _b.sent();
