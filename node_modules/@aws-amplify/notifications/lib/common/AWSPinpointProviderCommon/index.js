...
var AWSPinpointProviderCommon = /** @class */ (function () {
    function AWSPinpointProviderCommon(logger) {
        ...
        this.identifyUser = function (userId, userInfo, userAgentValue) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var err_1;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.updateEndpoint(userId, userInfo, userAgentValue)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
        ...
        this.updateEndpoint = function (userId, userInfo, userAgentValue) {
