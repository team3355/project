...
var Providers_1 = require("../InAppMessaging/Providers");
var types_1 = require("../InAppMessaging/types");
...
var InternalInAppMessagingClass = /** @class */ (function () {
    ...
    InternalInAppMessagingClass.prototype.configure = function (_a) {
        ...
        var _b = (notificationsConfig === null || notificationsConfig === void 0 ? void 0 : notificationsConfig.InAppMessaging) || {}, _c = _b.listenForAnalyticsEvents, listenForAnalyticsEvents = _c === void 0 ? true : _c, config = tslib_1.__rest(_b, ["listenForAnalyticsEvents"]);
        ...
        if (this.pluggables.length === 0) {
            this.addPluggable(new Providers_1.AWSPinpointProvider());
        }
        if (listenForAnalyticsEvents && !this.listeningForAnalyticEvents) {
            core_1.Hub.listen('analytics', this.analyticsListener);
    ...
    InternalInAppMessagingClass.prototype.syncMessages = function (customUserAgentDetails) {
        var _this = this;
        return Promise.all(this.pluggables.map(function (pluggable) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var messages, key, err_5;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, pluggable.getInAppMessages(utils_1.getUserAgentValue(core_1.InAppMessagingAction.SyncMessages, customUserAgentDetails))];
                    case 1:
                        messages = _a.sent();
        ...
        return Promise.all(this.pluggables.map(function (pluggable) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, pluggable.identifyUser(userId, userInfo, utils_1.getUserAgentValue(core_1.InAppMessagingAction.IdentifyUser, customUserAgentDetails))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
...
exports.InternalInAppMessagingClass = InternalInAppMessagingClass;
exports.InternalInAppMessaging = new InternalInAppMessagingClass();
core_1.Amplify.register(exports.InternalInAppMessaging);
//# sourceMappingURL=InternalInAppMessaging.js.map