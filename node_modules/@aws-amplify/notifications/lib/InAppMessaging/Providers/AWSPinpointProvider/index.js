...
var AWSPinpointProvider = /** @class */ (function (_super) {
    ...
    function AWSPinpointProvider() {
        ...
        _this.getInAppMessages = function (userAgentValue) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, pinpoint_1.getInAppMessages({ credentials: credentials, region: region, userAgentValue: userAgentValue }, input)];
                    case 5:
                        response = _b.sent();
